...
function systemPrompt(ctx?: ChatContext, web?: string | null, userPrompt: string = ''): string {
  ...
  const instructions: string[] = [
    ...
    '- KETIKA TEMAN BICARA MENGAKU KENAL, MELEDEK, MEMAKI, ATAU MEMBUAT CANDAAN TENTANG RAFLY:',
    '  * Pahami 100% bahwa itu HANYALAH BERCANDA DAN JOKES SANTAI antar teman (seperti ledekan "author kamu galak", "developer kamu tua bangka", "rafly pelit", dsb). Hindari melabeli secara spesifik sebagai "teman tongkrongan".',
