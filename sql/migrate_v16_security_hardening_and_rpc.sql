...
-- 8. Bersihkan Default Hash PIN 080402 dari Database (Temuan C1 & Catatan Keselamatan)
DELETE FROM public.admin_auth_config 
WHERE id = 'master_auth' 
  AND (pin_hash = '5d41402abc4b2a76b9719d911017c592' 
   OR pin_hash = 'bf4817a3a93c72957b44d3fa54e58849b294e094ed1be63a41b55979adcf705d'
   OR pin_hash = 'db533e5fe9b399627eb386c19c967aa171dbc121a43fda2fa583c0a731aba78c');
